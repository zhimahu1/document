...
--
-- Table structure for table `rule_pin_risk`
--

DROP TABLE IF EXISTS `rule_pin_risk`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rule_pin_risk` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `pin` varchar(64) NOT NULL DEFAULT '' COMMENT '用户pin',
...
) ENGINE=InnoDB AUTO_INCREMENT=311987 DEFAULT CHARSET=utf8 COMMENT='风控pin规则';
